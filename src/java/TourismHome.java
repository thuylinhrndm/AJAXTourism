 ...
 * @author THUYLINH
 */
@WebServlet(name="TourismHome", urlPatterns={"/TourismHome"})
public class TourismHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String XMLFileName = path + "/tourism.xml";
            String XSLFileName = path + "/tourismhome.xsl";
